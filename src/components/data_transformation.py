...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        ...
        try:
            ...
            logging.info("Exception occured in get_data_transformation_object Method")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            ## Transforming data using preprocessor object
            ...
            save_object(
                file_path=self.transformationConfig.preprocess_obj_file_path,
            ...
            return (
                train_arr,
                test_arr,
                self.transformationConfig.preprocess_obj_file_path, 
